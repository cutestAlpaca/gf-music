...
func init() {
	qZone = g.Cfg("private").GetString("qiniu.Zone")
	qBucket = g.Cfg("private").GetString("qiniu.Bucket")
	qImgPath = g.Cfg("private").GetString("qiniu.ImgPath")
	qUseHTTPS = g.Cfg("private").GetBool("qiniu.UseHTTPS")
	qAccessKey = g.Cfg("private").GetString("qiniu.AccessKey")
	qSecretKey = g.Cfg("private").GetString("qiniu.SecretKey")
	qUseCdnDomains = g.Cfg("private").GetBool("qiniu.UseCdnDomains")
}
