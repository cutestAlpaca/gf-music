...
var (
	...
	Columns = struct {
		InfoId         string // è®¿é—®ID                                 
        LoginName      string // ç™»å½•è´¦å·                              
        Ipaddr         string // ç™»å½•IPåœ°å€                            
        LoginLocation  string // ç™»å½•åœ°ç‚¹                             
        Browser        string // æµè§ˆå™¨ç±»åž‹                           
        Os             string // æ“ä½œç³»ç»Ÿ                               
        Status         string // ç™»å½•çŠ¶æ€ï¼ˆ0æˆåŠŸ 1å¤±è´¥ï¼‰  
        Msg            string // æç¤ºæ¶ˆæ¯                                
        LoginTime      string // è®¿é—®æ—¶é—´                       
        Module         string // ç™»å½•æ¨¡å—
	}{
		InfoId:        "info_id",         
