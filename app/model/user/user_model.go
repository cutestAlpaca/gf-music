...
var (
	...
	Columns = struct {
        ...
        Mobile         string // ä¸­å›½æ‰‹æœºä¸å¸¦å›½å®¶ä»£ç ï¼Œå›½é™…æ‰‹æœºå·æ ¼å¼ä¸ºï¼šå›½å®¶ä»£ç -æ‰‹æœºå·  
        UserNickname   string // ç”¨æˆ·æ˜µç§°                                                                                                 
        Birthday       string // ç”Ÿæ—¥                                                                                                           
        CreateTime     string // æ³¨å†Œæ—¶é—´                                                                                             
        UserPassword   string // ç™»å½•å¯†ç ;cmf_passwordåŠ å¯†                                                                                 
        UserStatus     string // ç”¨æˆ·çŠ¶æ€;0:ç¦ç”¨,1:æ­£å¸¸,2:æœªéªŒè¯                                                           
        UserEmail      string // ç”¨æˆ·ç™»å½•é‚®ç®±                                                                                       
        Sex            string // æ€§åˆ«;0:ä¿å¯†,1:ç”·,2:å¥³                                                                                  
        Avatar         string // ç”¨æˆ·å¤´åƒ                                                                                                   
        LastLoginTime  string // æœ€åŽç™»å½•æ—¶é—´                                                                                       
        LastLoginIp    string // æœ€åŽç™»å½•ip                                                                                                 
        DeptId         string // éƒ¨é—¨id                                                                                                       
        Remark         string // å¤‡æ³¨                                                                                                         
        IsAdmin        string // æ˜¯å¦åŽå°ç®¡ç†å‘˜ 1 æ˜¯  0   å¦
	}{
		Id:            "id",               
        UserName:      "user_name",        
        Mobile:        "mobile",           
