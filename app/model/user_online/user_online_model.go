...
var (
	...
	Table = "user_online"
	// Model is the model object of user_online.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table user_online.
	Columns = struct {
		Id          string //                        
        Uuid        string // ç”¨æˆ·æ ‡è¯†   
        Token       string // ç”¨æˆ·token        
        CreateTime  string // ç™»å½•æ—¶é—´  
        UserName    string // ç”¨æˆ·å            
        Ip          string // ç™»å½•ip            
        Explorer    string // æµè§ˆå™¨          
